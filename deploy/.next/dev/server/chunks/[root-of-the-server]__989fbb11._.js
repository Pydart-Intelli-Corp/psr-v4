...
"[project]/src/app/api/user/ratechart/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    `);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSuccessResponse"])('Rate charts retrieved successfully', rateCharts);
    } catch (error) {
        console.error('Error fetching rate charts:', error);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])('Failed to fetch rate charts', 500);
    }
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__989fbb11._.js.map