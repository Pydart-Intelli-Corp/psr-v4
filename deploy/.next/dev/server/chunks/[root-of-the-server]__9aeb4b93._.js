...
"[project]/src/app/api/auth/check-status/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        if (!validation.success) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$middleware$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])('Email is required', 400);
        }
        // Find user by email
        ...
        let nextAction = '';
        switch(user.status){
            case __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UserStatus"].PENDING:
                ...
                break;
            case __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UserStatus"].PENDING_APPROVAL:
                ...
                break;
            case __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UserStatus"].ACTIVE:
                statusMessage = 'Account is active and ready to use.';
                statusType = 'active';
                canLogin = true;
                nextAction = 'login';
                break;
            case __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UserStatus"].INACTIVE:
                statusMessage = 'Account has been deactivated. Please contact support for assistance.';
                statusType = 'inactive';
                nextAction = 'contact_support';
                break;
            case __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UserStatus"].SUSPENDED:
        ...
        if (user.role === 'admin' && user.status === __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UserStatus"].INACTIVE && user.isEmailVerified) {
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$middleware$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSuccessResponse"])(response, statusMessage);
    } catch (error) {
        console.error('Account status check error:', error);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$middleware$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])('Failed to check account status. Please try again.', 500);
    }
}
async function GET(request) {
    ...
    if (!email) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$middleware$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])('Email parameter is required', 400);
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9aeb4b93._.js.map