...
"[project]/src/app/api/external/auth/send-otp/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function findEntityByEmail(email) {
  ...
  `);
    const adminLookup = adminUsers.reduce((acc, admin)=>{
...
async function POST(request) {
    try {
        ...
        const { email } = body;
        if (!email || !email.trim()) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])('Email address is required', 400);
        }
        ...
        if (!result.found) {
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])('Email address not found. Please contact your supervisor for registration.', 404);
        }
        // Generate OTP
        ...
        if (!result.entityType || !result.schemaName || !result.adminInfo) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])('Invalid entity data found', 500);
        }
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$emailService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendOTPEmail"])(email, otp, entityName);
            console.log(`✅ OTP sent successfully to ${email} for ${result.entityType}: ${entityName}`);
        } catch (emailError) {
            console.error('Failed to send OTP email:', emailError);
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])('Failed to send OTP. Please try again later.', 500);
        }
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSuccessResponse"])('OTP sent successfully to your email address', {
            email,
            entityType: result.entityType,
            entityName,
            adminName: result.adminInfo?.fullName,
            message: `OTP sent to ${email}. Please check your email and enter the 6-digit code.`,
            debug_otp: otp // TEMPORARY: For testing purposes
        });
    } catch (error) {
        console.error('Error in send-otp:', error);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])('Failed to process request', 500);
    }
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__74997702._.js.map