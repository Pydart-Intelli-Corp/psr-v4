...
"[project]/src/app/api/analytics/farmer-performance/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    `;
        ...
        const topCollector = [
            ...farmers
        ].sort((a, b)=>(parseFloat(b.total_quantity) || 0) - (parseFloat(a.total_quantity) || 0))[0];
        const bestFat = [
            ...farmers
        ].sort((a, b)=>(parseFloat(b.avg_fat) || 0) - (parseFloat(a.avg_fat) || 0))[0];
        const bestSnf = [
            ...farmers
        ].sort((a, b)=>(parseFloat(b.avg_snf) || 0) - (parseFloat(a.avg_snf) || 0))[0];
        const topRevenue = [
            ...farmers
        ].sort((a, b)=>(parseFloat(b.total_amount) || 0) - (parseFloat(a.total_amount) || 0))[0];
        const mostActive = [
            ...farmers
        ].sort((a, b)=>parseInt(b.total_collections) - parseInt(a.total_collections))[0];
        const bestQuality = [
            ...farmers
        ].sort((a, b)=>(parseFloat(b.avg_rate) || 0) - (parseFloat(a.avg_rate) || 0))[0];
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            stats: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__89fc5a5a._.js.map