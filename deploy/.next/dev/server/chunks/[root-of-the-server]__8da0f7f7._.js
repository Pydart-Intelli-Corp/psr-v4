...
"[project]/src/app/api/superadmin/machines/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const { Machine } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getModels"])();
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$middleware$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])('Failed to fetch machines', 500);
    }
}
async function POST(request) {
    try {
        ...
        if (body.bulkData && Array.isArray(body.bulkData)) {
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$middleware$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSuccessResponse"])(results, `Bulk upload completed: ${results.success} created, ${results.duplicates} duplicates, ${results.failed} failed`);
        }
        ...
        if (!validation.success) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$middleware$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])(`Missing required fields: ${validation.missing?.join(', ')}`, 400);
        }
        ...
        if (existingMachine) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$middleware$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])('Machine type already exists', 409);
        }
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$middleware$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSuccessResponse"])(machine, 'Machine created successfully');
    } catch (error) {
        console.error('Error creating machine:', error);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$middleware$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])('Failed to create machine', 500);
    }
}
async function PUT(request) {
    try {
        ...
        if (!machine) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$middleware$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])('Machine not found', 404);
        }
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$middleware$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSuccessResponse"])(machine, 'Machine updated successfully');
    } catch (error) {
        console.error('Error updating machine:', error);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$middleware$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])('Failed to update machine', 500);
    }
}
async function DELETE(request) {
    try {
        ...
        if (!id) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$middleware$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])('Machine ID is required', 400);
        }
        const machine = await Machine.findByPk(id);
        if (!machine) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$middleware$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])('Machine not found', 404);
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$middleware$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSuccessResponse"])(null, 'Machine deleted successfully');
    } catch (error) {
        console.error('Error deleting machine:', error);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$middleware$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])('Failed to delete machine', 500);
    }
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__8da0f7f7._.js.map