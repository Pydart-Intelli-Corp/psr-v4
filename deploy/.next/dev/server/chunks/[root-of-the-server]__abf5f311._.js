...
"[project]/src/app/api/user/dairy/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const { name, password, dairyId, location, contactPerson, phone, email, capacity, status, monthlyTarget } = body;
        if (!name || !password || !dairyId) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])('Name, password, and dairy ID are required', 400);
        }
    ...
    `;
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSuccessResponse"])('Dairy farm added successfully', {
            dairyId,
            name,
            location,
            contactPerson,
        ...
        if (error instanceof Error && error.name === 'SequelizeUniqueConstraintError') {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])('Dairy ID already exists', 409);
        }
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])('Failed to add dairy farm', 500);
    }
}
async function GET(request) {
    ...
    `);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSuccessResponse"])('Dairy farms retrieved successfully', dairyFarms);
    } catch (error) {
        console.error('Error retrieving dairy farms:', error);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])('Failed to retrieve dairy farms', 500);
    }
}
async function DELETE(request) {
    try {
        ...
        if (!id) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])('Dairy ID is required', 400);
        }
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["connectDB"])();
        const { getModels } = await __turbopack_context__.A("[project]/src/models/index.ts [app-route] (ecmascript, async loader)");
        const { sequelize, User } = getModels();
    ...
    `, {
        ...
        if (bmcArray.length > 0) {
            if (deleteAll) {
                ...
                if (!otp) {
                    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])('OTP is required for delete all operation', 400);
                }
                const { verifyDeleteOTP } = await __turbopack_context__.A("[project]/src/app/api/user/dairy/send-delete-otp/route.ts [app-route] (ecmascript, async loader)");
                const isValidOTP = verifyDeleteOTP(payload.id, id, otp);
                if (!isValidOTP) {
                    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])('Invalid or expired OTP', 400);
                }
        ...
        `, {
                ...
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSuccessResponse"])('Dairy and all related data deleted successfully', {
                    deletedAll: true
                });
            } else {
                // Transfer BMCs to new dairy
                if (!newDairyId) {
                    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])('New dairy ID is required for transfer', 400);
                }
                // Verify OTP for transfer
                if (!otp) {
                    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])('OTP is required for transfer operation', 400);
                }
                const { verifyDeleteOTP } = await __turbopack_context__.A("[project]/src/app/api/user/dairy/send-delete-otp/route.ts [app-route] (ecmascript, async loader)");
                const isValidOTP = verifyDeleteOTP(payload.id, id, otp);
                if (!isValidOTP) {
        ...
        `, {
                ...
                if (!newDairy || newDairy.length === 0) {
                    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])('New dairy not found', 404);
                }
        ...
        `, {
                ...
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSuccessResponse"])('BMCs transferred and dairy deleted successfully', {
      ...
      `, {
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSuccessResponse"])('Dairy deleted successfully');
        }
    } catch (error) {
        console.error('Error deleting dairy farm:', error);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])('Failed to delete dairy farm', 500);
    }
}
async function PUT(request) {
    ...
    `;
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSuccessResponse"])('Dairy farm updated successfully', {
            id,
            name,
            location,
            contactPerson,
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])('Failed to update dairy farm', 500);
    }
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__abf5f311._.js.map