...
"[project]/src/app/api/user/dairy/password/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const dairyId = searchParams.get('id');
        if (!dairyId) {
        ...
        // Get Dairy password from admin's schema
        const [result] = await sequelize.query(`
      SELECT password FROM \`${schemaName}\`.\`dairy_farms\` WHERE id = ?
    `, {
            replacements: [
                dairyId
            ]
        ...
        const dairy = result[0];
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSuccessResponse"])('Password retrieved successfully', {
            password: dairy.password || ''
        });
    } catch (error) {
        console.error('Error retrieving Dairy password:', error);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])('Failed to retrieve password', 500);
    }
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__651d8bcd._.js.map