...
async function POST(request) {
    try {
        ...
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isSuperAdmin"])({
            email
        })) {
            const superAdminPassword = process.env.SUPER_ADMIN_PASSWORD || 'psr@2025';
            if (password !== superAdminPassword) {
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$middleware$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])('Invalid credentials', 401);
            }
            ...
            const superAdminUser = {
                ...
                uid: 'super-admin',
                email,
                role: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UserRole"].SUPER_ADMIN,
                dbKey: 'master'
            };
            const tokens = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateTokens"])(superAdminUser);
            // Set HTTP-only cookie
            const response = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$middleware$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSuccessResponse"])({
                user: {
        ...
        if (user.isLocked) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$middleware$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])('Account is temporarily locked due to multiple failed login attempts. Please try again later.', 423);
        }
        // Verify password
        ...
        if (user.status !== 'active') {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$middleware$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])('Your account is pending approval. Please wait for an administrator to approve your registration.', 403);
        }
        // Check if email is verified
        if (!user.isEmailVerified) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$middleware$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])('Please verify your email address before logging in.', 403);
        }
        ...
        // Generate tokens
        const tokens = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateTokens"])({
            id: user.id,
            uid: user.uid,
            email: user.email,
            role: user.role,
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$middleware$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])('Login failed. Please try again.', 500);
    }
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__03a59f46._.js.map