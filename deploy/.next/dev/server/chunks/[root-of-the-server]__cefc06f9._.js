...
"[project]/src/app/api/user/machine/correction/[machineId]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        const corrections = await sequelize.query(`SELECT 
        mc.id,
        mc.machine_id,
       ...
       LIMIT 30`, {
        ...
        const correctionData = corrections.map((correction)=>({
                id: correction.id,
...
async function DELETE(request, { params }) {
    try {
        ...
        if (!idsParam) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'No correction IDs provided'
            }, {
                status: 400
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cefc06f9._.js.map