...
"[project]/src/app/api/user/dairy/send-delete-otp/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const { dairyId } = body;
        if (!dairyId) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$middleware$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])('Dairy ID is required', 400);
        }
...
function verifyDeleteOTP(adminId, dairyId, otp) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e678762f._.js.map