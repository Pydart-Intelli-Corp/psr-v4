...
"[project]/src/lib/adminSchema.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s([
    ...
    "isDbKeyUnique",
    ()=>isDbKeyUnique,
    "updateAdminSchemasWithFarmersTable",
    ()=>updateAdminSchemasWithFarmersTable
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/database.ts [app-route] (ecmascript)");
;
function generateDbKey(fullName) {
...
async function isDbKeyUnique(dbKey) {
    try {
        ...
        const { User } = await __turbopack_context__.A("[project]/src/models/index.ts [app-route] (ecmascript, async loader)").then((m)=>m.getModels());
...
async function generateUniqueDbKey(fullName) {
    let dbKey;
    let attempts = 0;
...
async function createAdminSchema(adminUser, dbKey) {
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["connectDB"])();
        ...
        const { sequelize } = await __turbopack_context__.A("[project]/src/models/index.ts [app-route] (ecmascript, async loader)").then((m)=>m.getModels());
        // Create the schema
 ...
 */ async function createAdminTables(schemaName) {
    try {
        const { sequelize } = await __turbopack_context__.A("[project]/src/models/index.ts [app-route] (ecmascript, async loader)").then((m)=>m.getModels());
...
async function updateAdminSchemasWithFarmersTable() {
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["connectDB"])();
...
"[project]/src/app/api/superadmin/approvals/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/database.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/models/User.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$adminSchema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/adminSchema.ts [app-route] (ecmascript)");
;
;
;
;
...
async function GET() {
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["connectDB"])();
        const { User } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getModels"])();
        // Get all pending admin approvals
        const pendingAdmins = await User.findAll({
            where: {
                role: 'admin',
                status: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UserStatus"].PENDING_APPROVAL,
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$middleware$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSuccessResponse"])(pendingAdmins, 'Pending admin approvals retrieved successfully');
    } catch (error) {
        console.error('Get pending approvals error:', error);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$middleware$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])('Failed to retrieve pending approvals', 500);
    }
}
async function POST(request) {
    try {
        ...
        const validation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$middleware$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["validateRequiredFields"])(body, [
            'adminId',
            'action'
        ]);
        if (!validation.success) {
            const missingFields = validation.missing?.join(', ') || 'Required fields missing';
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$middleware$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])(`Missing required fields: ${missingFields}`, 400);
        }
        if (![
            'approve',
            'reject'
        ].includes(action)) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$middleware$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])('Invalid action. Must be "approve" or "reject"', 400);
        }
        // Find the admin user
        ...
        if (!adminUser) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$middleware$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])('Admin user not found or not pending approval', 404);
        }
        if (action === 'approve') {
            // Generate unique dbKey for the admin
            const dbKey = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$adminSchema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateUniqueDbKey"])(adminUser.fullName);
            // Update admin with dbKey and activate account
            await adminUser.update({
                status: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UserStatus"].ACTIVE,
                dbKey: dbKey
            });
            console.log(`🔑 Generated dbKey for ${adminUser.fullName}: ${dbKey}`);
            // Create dedicated schema for the admin
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$adminSchema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createAdminSchema"])(adminUser.toJSON(), dbKey);
                ...
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$middleware$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])('Failed to create admin database schema. Please try again.', 500);
            }
            // Send welcome email with dbKey
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$emailService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendAdminWelcomeEmail"])(adminUser.email, adminUser.fullName, dbKey);
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$middleware$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSuccessResponse"])('Admin account approved successfully', JSON.stringify(userResponse));
        } else {
            // Reject the admin
            await adminUser.update({
                status: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UserStatus"].INACTIVE
            });
            // Send rejection email with reason
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$emailService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendAdminRejectionEmail"])(adminUser.email, adminUser.fullName, reason // Optional rejection reason
                );
                console.log('✅ Rejection email sent to admin');
            } catch (emailError) {
                console.error('⚠️ Failed to send rejection email:', emailError);
            }
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$middleware$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSuccessResponse"])('Admin account rejected successfully', JSON.stringify({
                id: adminUser.id,
                status: 'rejected',
                reason
            }));
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$middleware$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])('Failed to process admin approval', 500);
    }
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__115f869f._.js.map