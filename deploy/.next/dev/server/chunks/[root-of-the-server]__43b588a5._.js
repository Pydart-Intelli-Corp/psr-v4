...
"[project]/src/app/api/user/machine-correction/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const user = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["verifyToken"])(token);
        if (!user) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: 'Unauthorized'
        ...
        if (user.role !== __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UserRole"].ADMIN) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: 'Only admins can add correction data'
            }, {
                status: 403
            });
        }
        ...
        const { machineId, societyId, channel1_fat, channel1_snf, channel1_clr, channel1_temp, channel1_water, channel1_protein, channel2_fat, channel2_snf, channel2_clr, channel2_temp, channel2_water, channel2_protein, channel3_fat, channel3_snf, channel3_clr, channel3_temp, channel3_water, channel3_protein } = body;
        // Validate required fields
        if (!machineId || !societyId) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: 'Machine ID and Society ID are required'
            }, {
                status: 400
            });
        }
        ...
        const [machineResult] = await sequelize.query(`SELECT machine_type FROM \`${schemaName}\`.\`machines\` WHERE id = :machineId LIMIT 1`, {
            replacements: {
                machineId
            },
        ...
        try {
            ...
            await sequelize.query(`UPDATE \`${schemaName}\`.\`machine_corrections\` 
         SET status = 0 
         WHERE machine_id = :machineId AND status = 1`, {
                replacements: {
                    machineId
                },
                type: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sequelize$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["QueryTypes"].UPDATE,
                transaction
            });
            // Insert new correction data with status 1 (active)
            await sequelize.query(`INSERT INTO \`${schemaName}\`.\`machine_corrections\` (
          machine_id,
          society_id,
          machine_type,
          channel1_fat,
          ...
          NOW()
                ...
                type: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sequelize$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["QueryTypes"].INSERT,
                transaction
            });
            // Keep only the last 5 records for this machine (delete older ones)
            // First, get the IDs of records to keep
            const recordsToKeep = await sequelize.query(`SELECT id FROM \`${schemaName}\`.\`machine_corrections\` 
         ...
         LIMIT 5`, {
            ...
            if (recordsToKeep.length > 0) {
                ...
                await sequelize.query(`DELETE FROM \`${schemaName}\`.\`machine_corrections\` 
           WHERE machine_id = :machineId 
           AND id NOT IN (:idsToKeep)`, {
                    ...
                    type: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sequelize$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["QueryTypes"].DELETE,
                    transaction
                });
            }
            // Commit transaction
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
            error: error instanceof Error ? error.message : 'Failed to save correction data'
        }, {
            status: 500
        });
    }
...
async function GET(request) {
    try {
        ...
        if (user.role !== __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UserRole"].ADMIN) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: 'Only admins can view correction data'
            }, {
                status: 403
            });
        }
        ...
        const corrections = await sequelize.query(`SELECT * FROM \`${schemaName}\`.\`machine_corrections\` 
       WHERE machine_id = :machineId 
       ORDER BY created_at DESC
       LIMIT 5`, {
            replacements: {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
            error: error instanceof Error ? error.message : 'Failed to fetch correction data'
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__43b588a5._.js.map