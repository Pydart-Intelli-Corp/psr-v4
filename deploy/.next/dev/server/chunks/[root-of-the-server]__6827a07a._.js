...
"[project]/src/app/api/auth/resend-otp/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        if (!user) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$middleware$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])('User not found or already verified', 404);
        }
        ...
        if (user.emailVerificationExpires) {
            ...
            if (timeSinceLastOTP < 60 * 1000) {
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$middleware$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])('Please wait before requesting a new OTP', 429);
            }
        }
        // Generate new OTP
        ...
        try {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$emailService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendOTPEmail"])(user.email, otp, user.fullName);
        } catch (emailError) {
            console.error('OTP email sending failed:', emailError);
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$middleware$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])('Failed to send OTP email. Please try again.', 500);
        }
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$middleware$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSuccessResponse"])('OTP sent successfully. Please check your email.', JSON.stringify({
            email: user.email,
            expiresIn: '10 minutes'
        }));
    } catch (error) {
        console.error('OTP resend error:', error);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$middleware$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])('Failed to send OTP. Please try again.', 500);
    }
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__6827a07a._.js.map