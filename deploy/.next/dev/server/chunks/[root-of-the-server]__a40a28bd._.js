...
"[project]/src/app/api/user/machine/statistics/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const [machineResults] = await sequelize.query(`SELECT id FROM \`${schemaName}\`.machines WHERE id = ?`, {
            replacements: [
                machineId
            ],
        ...
        const statisticsResults = await sequelize.query(`SELECT 
        id,
        machine_id,
        society_id,
        machine_type,
...
async function DELETE(request) {
    try {
        ...
        if (!idsParam) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: 'No statistics IDs provided'
            }, {
                status: 400
            });
        }
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
            error: 'Failed to delete machine statistics'
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a40a28bd._.js.map