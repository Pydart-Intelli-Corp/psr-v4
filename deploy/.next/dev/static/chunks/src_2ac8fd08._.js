    ...
    const handleSave = async ()=>{
        ...
        try {
            ...
            if (response.ok) {
                ...
                setError(errorData.message || errorData.error || 'Failed to save farmer details');
            }
        } catch (error) {
...
_s(FarmerDetails, "LYCX8ugcKXJbfk7geEVSBPKai6w=", false, function() {
    return [
...
//# sourceMappingURL=src_2ac8fd08._.js.map